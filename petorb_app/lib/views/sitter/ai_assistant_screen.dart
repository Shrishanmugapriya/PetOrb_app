...
class SitterAiAssistantScreen extends StatefulWidget {
  final PetModel pet;

  const SitterAiAssistantScreen({super.key, required this.pet});

  @override
  State<SitterAiAssistantScreen> createState() => _SitterAiAssistantScreenState();
}

class _SitterAiAssistantScreenState extends State<SitterAiAssistantScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            onPressed: () async {
              final confirm = await showDialog<bool>(
                ...
                builder: (c) => AlertDialog(
                  ...
                  content: const Text('Are you sure you want to delete your care chat history?'),
                  actions: [
      ...
      body: Container(
        ...
        child: Column(
          children: [
            // Sitter Restrictions Info Banner
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '🔒 Sitter Mode: AI answers feeding, care, and behavior questions. Profile changes and owner contact queries are locked.',
                      style: TextStyle(color: AppColors.primaryText, fontSize: 11, fontWeight: FontWeight.w600),
                    ),
                  ),
                ],
              ),
